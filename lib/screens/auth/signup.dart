    ...
    provider.createAccount(
       ...
       /*  setState(() {
          ...
          if (response.isLoading) {
            //TODO PLEASE HANDLE PROGRESS BAR USING setState with a loading variable.
            /*
          ...
          if (response.data != null) {
            final result = response.data as CreateAccountUserResult?;
            //TODO NAVIGATE TO YOUR SCREEN HERE
            print("********** successful ****************");
            return;
          }
        });
